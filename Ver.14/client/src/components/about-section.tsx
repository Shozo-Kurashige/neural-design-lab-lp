          ...
          <div>
            ...
            <FadeIn delay={200}>
              <div className="space-y-6 text-gray-600 leading-loose text-justify font-medium mb-10">
                <p>
                  「日本が二流国の仲間入りするのではないか」そんな声が聞こえる昨今、我が国を取り巻く環境は厳しさを増し、国内でも企業の成長が二極化していると分析されています。
                  大手企業はその調達力と人材の囲い込みで大きく成長し、日本の約90％をしめる中小・零細企業はDX化やAI導入がなかなか進まず、「レガシー（遺産）」などと揶揄される風潮もあります。
                </p>
                <p>
                  経済を牽引してきた大手企業を非難するつもりはありませんが、我が国の経済を支えてきたのは間違いなく「中小企業」です。
                </p>
                <p>
                  また、震災で傷ついた地方都市に対し、「疎開すればいい」などという心無い言葉も耳にします。
                  東西に長く伸びる美しい国土。身体の隅々まで血液が行き渡らないと、人間の身体はどうなってしまうでしょうか。国土も同じです。
                </p>
                <p>
                  安全に暮らしていけるよう、地方の活性化なくしては国土の維持もままならないと私は考えます。
                </p>
                <p>
                  私は、いわゆる「エリート街道」を歩んできた人間ではありません。泥臭い現場で汗をかき、理不尽なトラブルに頭を下げ、「どうすればもっと楽になるのか」「どうすれば成果が出るのか」を地べたで考え続け、身を守る武器としてDXツールやAIを習得してきた人間です。
                </p>
                <p>
                  AIや最新技術は、若者や一部の天才だけのものではありません。むしろ、酸いも甘いも噛み分けた私たち世代こそが、この強力な道具を使いこなし、次世代にバトンを渡すべきだと信じています。
                </p>
                <p>
                  今は小さな一歩ですが、同じ志を持つ仲間と共に、地方と中小企業の未来を耕していきたいと考えています。「先生」ではなく「パートナー」として。あなたの現場に、私たちを招いてください。
                </p>
              </div>
